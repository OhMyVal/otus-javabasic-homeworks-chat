...
//            this.role = role;
    ...
    private static final String USERS_ADD_QUERY = "INSERT * INTO users (id, login, password, nickname) values (?, 'login' + ?, 'pass' + ?, 'nick' + ?)";
...
//        try (PreparedStatement ps = connection.prepareStatement(USER_ROLE_QUERY)) { // создаем объект PreparedStatement ps,
